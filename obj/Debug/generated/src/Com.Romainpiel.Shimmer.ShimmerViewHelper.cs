...
namespace Com.Romainpiel.Shimmer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']"
	[global::Android.Runtime.Register ("com/romainpiel/shimmer/ShimmerViewHelper", DoNotGenerateAcw=true)]
	public partial class ShimmerViewHelper : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/romainpiel/shimmer/ShimmerViewHelper", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ShimmerViewHelper); }
		}

		protected ShimmerViewHelper (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_view_View_Landroid_graphics_Paint_Landroid_util_AttributeSet_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/constructor[@name='ShimmerViewHelper' and count(parameter)=3 and parameter[1][@type='android.view.View'] and parameter[2][@type='android.graphics.Paint'] and parameter[3][@type='android.util.AttributeSet']]"
		[Register (".ctor", "(Landroid/view/View;Landroid/graphics/Paint;Landroid/util/AttributeSet;)V", "")]
		public ShimmerViewHelper (global::Android.Views.View p0, global::Android.Graphics.Paint p1, global::Android.Util.IAttributeSet p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ShimmerViewHelper)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/view/View;Landroid/graphics/Paint;Landroid/util/AttributeSet;)V", new JValue (p0), new JValue (p1), new JValue (p2)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/view/View;Landroid/graphics/Paint;Landroid/util/AttributeSet;)V", new JValue (p0), new JValue (p1), new JValue (p2));
				return;
			}

			if (id_ctor_Landroid_view_View_Landroid_graphics_Paint_Landroid_util_AttributeSet_ == IntPtr.Zero)
				id_ctor_Landroid_view_View_Landroid_graphics_Paint_Landroid_util_AttributeSet_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/view/View;Landroid/graphics/Paint;Landroid/util/AttributeSet;)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_view_View_Landroid_graphics_Paint_Landroid_util_AttributeSet_, new JValue (p0), new JValue (p1), new JValue (p2)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_view_View_Landroid_graphics_Paint_Landroid_util_AttributeSet_, new JValue (p0), new JValue (p1), new JValue (p2));
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Romainpiel.Shimmer.ShimmerViewHelper __this = global::Java.Lang.Object.GetObject<global::Com.Romainpiel.Shimmer.ShimmerViewHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual float GradientX {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='getGradientX' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='setGradientX' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		public virtual bool IsSetUp {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='isSetUp' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int PrimaryColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='getPrimaryColor' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='setPrimaryColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual int ReflectionColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='getReflectionColor' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='setReflectionColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual bool Shimmering {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='isShimmering' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='setShimmering' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		static IntPtr id_onDraw;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='onDraw' and count(parameter)=0]"
		...
		public virtual void OnDraw ()
		{
			...
			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_onDraw);
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onDraw", "()V"));
		}

		static Delegate cb_onSizeChanged;
#pragma warning disable 0169
		static Delegate GetOnSizeChangedHandler ()
		{
			if (cb_onSizeChanged == null)
				cb_onSizeChanged = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_OnSizeChanged);
			return cb_onSizeChanged;
		}

		static void n_OnSizeChanged (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Romainpiel.Shimmer.ShimmerViewHelper __this = global::Java.Lang.Object.GetObject<global::Com.Romainpiel.Shimmer.ShimmerViewHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_onSizeChanged;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='onSizeChanged' and count(parameter)=0]"
		[Register ("onSizeChanged", "()V", "GetOnSizeChangedHandler")]
		protected virtual void OnSizeChanged ()
		{
			if (id_onSizeChanged == IntPtr.Zero)
				id_onSizeChanged = JNIEnv.GetMethodID (class_ref, "onSizeChanged", "()V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_onSizeChanged);
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onSizeChanged", "()V"));
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerViewHelper']/method[@name='setAnimationSetupCallback' and count(parameter)=1 and parameter[1][@type='com.romainpiel.shimmer.AnimationSetupCallback']]"
