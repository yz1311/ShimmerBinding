...
namespace Com.Romainpiel.Shimmer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']"
	[global::Android.Runtime.Register ("com/romainpiel/shimmer/ShimmerTextView", DoNotGenerateAcw=true)]
	public partial class ShimmerTextView : global::Android.Widget.TextView, global::Com.Romainpiel.Shimmer.IShimmerViewBase {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/romainpiel/shimmer/ShimmerTextView", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ShimmerTextView); }
		}

		protected ShimmerTextView (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/constructor[@name='ShimmerTextView' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "")]
		public ShimmerTextView (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1, int p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ShimmerTextView)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/constructor[@name='ShimmerTextView' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "")]
		public ShimmerTextView (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/constructor[@name='ShimmerTextView' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public ShimmerTextView (global::Android.Content.Context p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Romainpiel.Shimmer.ShimmerTextView __this = global::Java.Lang.Object.GetObject<global::Com.Romainpiel.Shimmer.ShimmerTextView> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual float GradientX {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='getGradientX' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='setGradientX' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		public virtual bool IsSetUp {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='isSetUp' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int PrimaryColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='getPrimaryColor' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='setPrimaryColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual int ReflectionColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='getReflectionColor' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='setReflectionColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual bool Shimmering {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='isShimmering' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='setShimmering' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='onDraw' and count(parameter)=1 and parameter[1][@type='android.graphics.Canvas']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.romainpiel.shimmer']/class[@name='ShimmerTextView']/method[@name='setAnimationSetupCallback' and count(parameter)=1 and parameter[1][@type='com.romainpiel.shimmer.AnimationSetupCallback']]"
